                  ...
                  <div className="amperM">
                      <svg version="1.2" className="graph" aria-labelledby="title" role="img">
                          ...
                          <g className="data" data-setname="Our first data set">
                              ...
                              <circle className={this.state.seven?'none':'block'} cx="370" cy="200" data-value="6.7" r="4"></circle>
                              <line className={this.state.seven?'none':'block'} x1="330" x2="370" y1="190" y2="200" stroke="red"></line>
                              <circle className={this.state.eight?'none':'block'} cx="410" cy="205" data-value="6.7" r="4"></circle>
                              <line className={this.state.eight?'none':'block'} x1="370" x2="410" y1="200" y2="205" stroke="red"></line>
                              <circle className={this.state.nine?'none':'block'} cx="450" cy="210" data-value="6.7" r="4"></circle>
                              <line className={this.state.nine?'none':'block'} x1="410" x2="450" y1="205" y2="210" stroke="red"></line>
                              <circle className={this.state.ten?'none':'block'} cx="490" cy="205" data-value="6.7" r="4"></circle>
                              <line className={this.state.ten?'none':'block'} x1="450" x2="490" y1="210" y2="205" stroke="red"></line>
                              <circle className={this.state.eleven?'none':'block'} cx="530" cy="200" data-value="6.7" r="4"></circle>
                              <line className={this.state.eleven?'none':'block'} x1="490" x2="530" y1="205" y2="200" stroke="red"></line>
                              <circle className={this.state.twelve?'none':'block'} cx="570" cy="190" data-value="6.7" r="4"></circle>
                              <line className={this.state.twelve?'none':'block'} x1="530" x2="570" y1="200" y2="190" stroke="red"></line>
                          </g>
                      </svg>
                  </div>
              </div>
