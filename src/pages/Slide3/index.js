                    ...
                    <div className="demonstration">
                        <div className="demo1">
                            ...
                            <svg width="400" height="250" viewBox="0 0 500 350">
                                        ...
                                        <text x="55" y="128" className='minus'>-</text>):
...
Принцип дії.  Збіднену на носії область р-п переходу тут використано в якості діелектрика. Тому можна використати формулу електроємності плоского конденсатора"
 formula="Сб =Сб =(ε∙ε0∙Sp-n)/∆X"
dial='ε- діелектрична проникливість матеріалів n-р-переходу'
stala ='εо – стала'
plo='S – площа n-р-переходу'
 delta='Δх – ширина збідненого шару n-р-переходу'
text1="Плавна зміна ємності відбувається при зміні величини відємної напруги, від якої залежить ширина збідненого шару. Отже, бар’єрна ємність буде зменшуватись плавно.
